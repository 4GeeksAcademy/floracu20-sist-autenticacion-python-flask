...
from flask_cors import CORS #por un error en un consola
...
def login():
    ...
    user = User.query.filter_by(email=body['email']).first() #el first nos devuelve el primer elem
    print(user)
    if user is None:
        return jsonify({'msg': 'Email y/o contraseña inválidos'}), 400
